...
public class RemarkCommand extends Command {
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        // handle invalid indexes (which is > 0) (exists)
        ...
        model.setPerson(personToEdit, editedPerson); // update (replace) person
        model.updateFilteredPersonList(Model.PREDICATE_SHOW_ALL_PERSONS); // update gui to show all people
